    ...
    try {
     ...
     bcrypt.hash(req.body.password, saltRounds,async function (err, hash){
        ...
        const newUser =new User({
            ...
            password: hash ,    // password: md5(req.body.password)  //md5 for hashing password  
...
app.post("/login",async(req,res)=>{
    try {
      ...
      const password = req.body.password; // const password = md5(req.body.password);
